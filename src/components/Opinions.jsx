    ...
    <div className="p-4">
      ...
      <div className="flex flex-wrap flex-col md:flex-row justify-center items-center gap-4">
        ...
        <div className="bg-white md:w-5/12 border-2 border-purple-800 rounded-xl relative p-4">
          ...
          />
          <p className="text-center text-xl">
            Max se lo pasó genial cuando os lo deje las pasadas vacaciones.
            Gracias
          </p>
        ...
        <div className="bg-white md:w-5/12 border-2 border-purple-800 rounded-xl relative p-4">
          ...
          />
          <p className="text-center text-xl">
            ¡Rayo y Mía están felices! Muchas gracias ❤️ contigo los dejo
            tranquila 😊
          </p>
        ...
        <div className="bg-white md:w-5/12 border-2 border-purple-800 rounded-xl relative p-4">
          ...
          />
          <p className="text-center text-xl">
            Que bien lo pasan y que felices están 😍👏
          </p>
